...
from django.db.utils import DatabaseError, IntegrityError, InternalError, OperationalError
...
class TestLegNotMatchAccountCurrency(DataProvider, DbTransactionTestCase):
    def test_non_matching(self):
        ...
        with self.assertRaisesMessage((InternalError, OperationalError,), error_str):
